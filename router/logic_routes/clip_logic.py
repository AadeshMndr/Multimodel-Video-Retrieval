...
from service_layer.video_service.state import get_state as get_video_state, State as VideoState
...
def clip_logic(state: Main_State):
    ...
    # video_state = get_video_state(output_path=output_path, video_processor=video_processor, batch_size=settings.FRAME_BATCH_SIZE)
